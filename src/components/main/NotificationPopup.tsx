...
export const NotificationPopup = () => {
    ...
    return (
        <AnimatePresence>
            {showPopup && (
                <motion.div
                    className="fixed bottom-6 right-4 bg-white shadow-lg rounded-lg p-4 w-64 md:w-80 flex items-center gap-4 border border-gray-300"
